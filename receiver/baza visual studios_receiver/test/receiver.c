...
int main(void){
    ...
    if (usart_receive()==1) { //button 1
        
        PORTD = 0b00010000; //led1 on
        _delay_ms(500);
    }
    if (usart_receive()==2) {    //button 2
        PORTD = 0b00100000;//led2 on
        
        _delay_ms(500);
    }
     if (usart_receive()==3) {   //button 3
          
        PORTD = 0b01000000; //led3 on
        _delay_ms(500);
    }
     if (usart_receive()==4) {   //button 4
      
        PORTD = 0b10000000; //led4 on
        _delay_ms(500);
    }
