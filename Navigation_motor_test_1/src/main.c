...
// Start of the bridge, on the left of SDU when looking from Alsik
float destLatitude = 54.911576;
float destLongitude = 9.777477;
...
// the datashhet says max 400HZ, I put it to half
void Timer1_Init() {
...
ISR(USART3_RX_vect){
	...
	printf("headC: %0.0f, destHead: %0.0f\n", heading, destHeading);
